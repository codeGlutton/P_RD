...
UAnimNotify_ConditionalPlayNiagaraEffect::UAnimNotify_ConditionalPlayNiagaraEffect()
{
}
...
bool UAnimNotify_ConditionalPlayNiagaraEffect::ShouldPlayEffect(const USkeletalMeshComponent* MeshComp) const
{
	if (MeshComp == nullptr)
	{
		return false;
