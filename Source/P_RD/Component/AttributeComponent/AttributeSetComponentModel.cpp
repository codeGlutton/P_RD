...
FActiveAttributeEffectHandle::FActiveAttributeEffectHandle(int32 Index) : mIndex(Index)
{
}

FActiveAttributeEffectHandle FActiveAttributeEffectHandle::GenerateNewHandle(UAttributeSetComponentModel* OwningComponent)
{
    static int32 MaxHandleIndex = 0;
    FActiveGameplayEffectHandle NewHandle(MaxHandleIndex++);

    return MaxHandleIndex;
}
