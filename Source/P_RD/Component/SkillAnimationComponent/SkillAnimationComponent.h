...
protected:
	 ...
	 * @param SkillEndBarrier 스킬 연출 완료 시기를 제어하는 배리어
	 * @param VFXSpawnData VFX 스폰 요청 정보
	 * @param LocalDirection 방향
	 */
	void SpawnHitVFXOnSelf(TSharedPtr<FPresentationBarrier> SkillEndBarrier, const FVFXSpawnData& VFXSpawnData, ETileActorDirection LocalDirection) const;
	void SpawnHitVFXOnTile(TSharedPtr<FPresentationBarrier> SkillEndBarrier, const FVFXSpawnData& VFXSpawnData, const FTransform& Transform) const;
	/**
