...
namespace MercenaryHireDetail
{
	...
	const TCHAR* HeroPaths[CardCount] = {
		...
		TEXT("/Game/UI/Art/Marchbound/Mercenaries/T_MB_HireHero_Mage.T_MB_HireHero_Mage"),
		TEXT("/Game/UI/Art/Marchbound/Mercenaries/T_MB_HireHero_Ranger.T_MB_HireHero_Ranger"),
		TEXT("/Game/UI/Art/Marchbound/Mercenaries/T_MB_HireHero_Rogue.T_MB_HireHero_Rogue"),
		TEXT("/Game/UI/Art/Marchbound/Mercenaries/T_MB_HireHero_Barbarian.T_MB_HireHero_Barbarian"),
		TEXT("/Game/UI/Art/Marchbound/Mercenaries/T_MB_HireHero_Druid.T_MB_HireHero_Druid")
	};
