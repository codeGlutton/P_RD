...
public:
	...
	// 실제 지급(다이스/스킬/장비/골드 추가)은 게임플레이가 한다. ViewModel은 선택 신호만 보낸다.
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "Reward|Push") void SetRewardChoices(const TArray<FRewardChoiceView>& Choices);
...
public:
	...
	UFUNCTION(BlueprintPure, Category = "Reward|Read") const TArray<FRewardChoiceView>& GetRewardChoices() const { return mChoices; }
...
private:
	...
	UPROPERTY(Transient) TArray<FRewardChoiceView> mChoices;
};
