...
private:
	...
	/** @brief 중앙 하단의 아이콘 전용 스킬 바로가기 한 칸. */
	struct FQuickSkillWidgets
	{
		TObjectPtr<UWidget> Root;
		TObjectPtr<UImage> Icon;
		TObjectPtr<UTextBlock> Cooldown;
	...
	TArray<FQuickSkillWidgets> mQuickSkillSlots;
	TObjectPtr<UWidget> mQuickSkillBar;
