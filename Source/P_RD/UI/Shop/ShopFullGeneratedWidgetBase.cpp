	...
	const bool bSelected) const
{
	return LoadFullGeneratedTexture(bSelected
		? TEXT("/Game/UI/Shop/T_ShopFG_SkillSlot07_Square_Selected.T_ShopFG_SkillSlot07_Square_Selected")
		: TEXT("/Game/UI/Shop/T_ShopFG_SkillSlot07_Square.T_ShopFG_SkillSlot07_Square"));
}
