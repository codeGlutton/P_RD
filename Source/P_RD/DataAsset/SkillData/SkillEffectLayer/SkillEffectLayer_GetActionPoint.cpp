...
TArray<FActiveTacticalEffectHandle> FSkillEffectLayer_GetActionPoint::ApplyFactorEffect(IBoardCombatTarget* ActorModel, const UBoardCombatTargetSnapshotData* Snapshot) const
{
