...
struct P_RD_API FSkillEffectLayer_Agility : public FSkillEffectLayer
{
	GENERATED_BODY()
...
public:
	UPROPERTY(Category = "Agility", EditAnywhere, BlueprintReadWrite, meta = (DisplayName = "DefaultTagGain"))
	float mDefaultTagGain = 0.f;
	UPROPERTY(Category = "Agility", EditAnywhere, BlueprintReadWrite, meta = (DisplayName = "DiceRatio"))
