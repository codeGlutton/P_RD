...
void UUnitAttributeSet::PreAttributeBaseChange(const FTacticalAttribute& Attribute, float& NewValue) const
{
	/* 충전 값 감소 시, 마이너스 방지 */
	if (Attribute == GetRechargeActionPointAttribute() || Attribute == GetRechargeSpeedPointAttribute())
	{
...
void UUnitAttributeSet::PostAttributeBaseChange(const FTacticalAttribute& Attribute, float OldValue, float NewValue) const
{
...
void UPlayerUnitAttributeSet::PreAttributeBaseChange(const FTacticalAttribute& Attribute, float& NewValue) const
{
	/* 경험치 감소 시, 마이너스 방지 */
	if (Attribute == GetExpAttribute())
	{
...
void UPlayerUnitAttributeSet::PostAttributeBaseChange(const FTacticalAttribute& Attribute, float OldValue, float NewValue) const
{
	Super::PostAttributeBaseChange(Attribute, OldValue, NewValue);
