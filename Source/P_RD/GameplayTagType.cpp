...
namespace AnimationTags
{
	...
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Mercenary_Mage_EarthQuake,				"Animation.Montage.Skill.Mercenary.Mage.EarthQuake");
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Mercenary_Mage_EldritchBlast,			"Animation.Montage.Skill.Mercenary.Mage.EldritchBlast");
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Mercenary_Mage_FireBall,					"Animation.Montage.Skill.Mercenary.Mage.FireBall");
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Mercenary_Mage_Gust,						"Animation.Montage.Skill.Mercenary.Mage.Gust");
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Mercenary_Mage_IceShield,				"Animation.Montage.Skill.Mercenary.Mage.IceShield");
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Mercenary_Mage_Curse,					"Animation.Montage.Skill.Mercenary.Mage.Curse");
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Mercenary_Mage_Collapse,					"Animation.Montage.Skill.Mercenary.Mage.Collapse");
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Mercenary_Mage_Surprise,					"Animation.Montage.Skill.Mercenary.Mage.Surprise");
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Mercenary_Mage_Thunderbolt,				"Animation.Montage.Skill.Mercenary.Mage.Thunderbolt");
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Mercenary_Mage_Disintegration,			"Animation.Montage.Skill.Mercenary.Mage.Disintegration");
	...
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Mercenary_Rogue_SleightOfHand,			"Animation.Montage.Skill.Mercenary.Rogue.SleightOfHand");
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Mercenary_Rogue_Assassinate,				"Animation.Montage.Skill.Mercenary.Rogue.Assassinate");
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Mercenary_Rogue_SharpenBlade,			"Animation.Montage.Skill.Mercenary.Rogue.SharpenBlade");
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Mercenary_Rogue_OilOfSharpness,			"Animation.Montage.Skill.Mercenary.Rogue.OilOfSharpness");
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Mercenary_Rogue_ExploitWeakness,			"Animation.Montage.Skill.Mercenary.Rogue.ExploitWeakness");
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Mercenary_Rogue_QuadrupleSlash,			"Animation.Montage.Skill.Mercenary.Rogue.QuadrupleSlash");
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Mercenary_Rogue_BladeRuch,				"Animation.Montage.Skill.Mercenary.Rogue.BladeRuch");
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Mercenary_Rogue_SandToss,				"Animation.Montage.Skill.Mercenary.Rogue.SandToss");
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Mercenary_Rogue_PoisonAttack,			"Animation.Montage.Skill.Mercenary.Rogue.PoisonAttack");
	...
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Mercenary_Druid_Heal,					"Animation.Montage.Skill.Mercenary.Druid.Heal");
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Mercenary_Druid_Rend,					"Animation.Montage.Skill.Mercenary.Druid.Rend");
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Mercenary_Druid_StarFall,				"Animation.Montage.Skill.Mercenary.Druid.StarFall");
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Mercenary_Druid_PoisonCloud,				"Animation.Montage.Skill.Mercenary.Druid.PoisonCloud");
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Mercenary_Druid_FlashFruit,				"Animation.Montage.Skill.Mercenary.Druid.FlashFruit");
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Mercenary_Druid_Prayer,					"Animation.Montage.Skill.Mercenary.Druid.Prayer");
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Mercenary_Druid_SnaringVines,			"Animation.Montage.Skill.Mercenary.Druid.SnaringVines");
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Mercenary_Druid_Roots,					"Animation.Montage.Skill.Mercenary.Druid.Roots");
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Mercenary_Druid_VineWhip,				"Animation.Montage.Skill.Mercenary.Druid.VineWhip");
	...
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Monster_Mushroom_Bodyslam,				"Animation.Montage.Skill.Enemy.Mushroom.Bodyslam");
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Monster_Mushroom_Spore_Exhaustion,		"Animation.Montage.Skill.Enemy.Mushroom.Spore.Exhaustion");
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Monster_Mushroom_Spore_Frail,			"Animation.Montage.Skill.Enemy.Mushroom.Spore.Frail");

	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Monster_Stump_Bodyslam,					"Animation.Montage.Skill.Enemy.Stump.Bodyslam");
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Monster_Stump_Grow,						"Animation.Montage.Skill.Enemy.Stump.Grow");

	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Monster_Spider_Bite,						"Animation.Montage.Skill.Enemy.Spider.Bite");
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Monster_Spider_PoisonSting,				"Animation.Montage.Skill.Enemy.Spider.PoisonSting");
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Monster_Spider_Web,						"Animation.Montage.Skill.Enemy.Spider.Web");
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Monster_Spider_Web_Explosion,			"Animation.Montage.Skill.Enemy.Spider.Web.Explosion");
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Monster_Spider_Web_Roots,				"Animation.Montage.Skill.Enemy.Spider.Web.Roots");

	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Monster_Slime_Bodyslam,					"Animation.Montage.Skill.Enemy.Slime.Bodyslam");
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Monster_Slime_Dissolve_Weapon,			"Animation.Montage.Skill.Enemy.Slime.Dissolve.Weapon");
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Monster_Slime_Dissolve_Equipment,		"Animation.Montage.Skill.Enemy.Slime.Dissolve.Equipment");
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Monster_Slime_Explosion,					"Animation.Montage.Skill.Enemy.Slime.Explosion");

	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Monster_Eagle_Attack,					"Animation.Montage.Skill.Enemy.Eagle.Attack");
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Monster_Eagle_BlindnessAttack,			"Animation.Montage.Skill.Enemy.Eagle.BlindnessAttack");
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Monster_Eagle_WindyWing,					"Animation.Montage.Skill.Enemy.Eagle.WindyWing");

	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Monster_Golem_Swing,						"Animation.Montage.Skill.Enemy.Golem.Swing");
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Monster_Golem_EarthQuake, 				"Animation.Montage.Skill.Enemy.Golem.EarthQuake");
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Monster_Golem_Stamp, 					"Animation.Montage.Skill.Enemy.Golem.Stamp");

	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Monster_Werewolf_Claw,					"Animation.Montage.Skill.Enemy.Werewolf.Claw");
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Monster_Werewolf_Howling,				"Animation.Montage.Skill.Enemy.Werewolf.Howling");
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Monster_Werewolf_Pierce,					"Animation.Montage.Skill.Enemy.Werewolf.Pierce");

	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Monster_Leshy_Attack,					"Animation.Montage.Skill.Enemy.Leshy.Attack");
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Monster_Leshy_Curse,						"Animation.Montage.Skill.Enemy.Leshy.Curse");
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Monster_Leshy_Vine_Pull,					"Animation.Montage.Skill.Enemy.Leshy.Vine.Pull");
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Monster_Leshy_Vine_Roots,				"Animation.Montage.Skill.Enemy.Leshy.Vine.Roots");

	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Monster_Skeleton_Melee_Punch,			"Animation.Montage.Skill.Enemy.Skeleton.Melee.Punch");
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Monster_Skeleton_Melee_BoneStrike,		"Animation.Montage.Skill.Enemy.Skeleton.Melee.BoneStrike");
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Monster_Skeleton_Melee_Clatter,			"Animation.Montage.Skill.Enemy.Skeleton.Melee.Clatter");

	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Monster_Skeleton_Ranged_Shot,			"Animation.Montage.Skill.Enemy.Skeleton.Ranged.Shot");
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Monster_Skeleton_Ranged_ClaimtheBone,	"Animation.Montage.Skill.Enemy.Skeleton.Ranged.ClaimtheBone");

	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Monster_Bat_Bodyslam,					"Animation.Montage.Skill.Enemy.Bat.Bodyslam");

	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Monster_Mimic_Surprise,					"Animation.Montage.Skill.Enemy.Mimic.Surprise");
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Monster_Mimic_Bite,						"Animation.Montage.Skill.Enemy.Mimic.Bite");

	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Monster_Pumpkin_ScytheSwing,				"Animation.Montage.Skill.Enemy.Pumpkin.ScytheSwing");
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Monster_Pumpkin_NastyTrick,				"Animation.Montage.Skill.Enemy.Pumpkin.NastyTrick");
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Monster_Pumpkin_ScytheSweep,				"Animation.Montage.Skill.Enemy.Pumpkin.ScytheSweep");
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Monster_Pumpkin_Chop,					"Animation.Montage.Skill.Enemy.Pumpkin.Chop");

	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Monster_HatchetBird_AxeSlam,				"Animation.Montage.Skill.Enemy.HatchetBird.AxeSlam");
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Monster_HatchetBird_BladeWind,			"Animation.Montage.Skill.Enemy.HatchetBird.BladeWind");
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Monster_HatchetBird_BladeStorm,			"Animation.Montage.Skill.Enemy.HatchetBird.BladeStorm");
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Monster_HatchetBird_Haste,				"Animation.Montage.Skill.Enemy.HatchetBird.Haste");

	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Monster_Skeleton_Golem_Swing,			"Animation.Montage.Skill.Enemy.Skeleton.Golem.Swing");
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Monster_Skeleton_Golem_Kick,				"Animation.Montage.Skill.Enemy.Skeleton.Golem.Kick");
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Monster_Skeleton_Golem_Stamp,			"Animation.Montage.Skill.Enemy.Skeleton.Golem.Stamp");
	UE_DEFINE_GAMEPLAY_TAG(Animation_Montage_Skill_Monster_Skeleton_Golem_Howl,				"Animation.Montage.Skill.Enemy.Skeleton.Golem.Howl");
...
namespace EffectTags
{
	...
	UE_DEFINE_GAMEPLAY_TAG(GameplayEffect_StatusEffect_RoundDuration_Buff_Haste,			"GameplayEffect.StatusEffect.RoundDuration.Buff.Haste");
	UE_DEFINE_GAMEPLAY_TAG(GameplayEffect_StatusEffect_RoundDuration_Buff_Fortification,	"GameplayEffect.StatusEffect.RoundDuration.Buff.Fortification");
	UE_DEFINE_GAMEPLAY_TAG(GameplayEffect_StatusEffect_RoundDuration_Debuff,				"GameplayEffect.StatusEffect.RoundDuration.Debuff");
	UE_DEFINE_GAMEPLAY_TAG(GameplayEffect_StatusEffect_RoundDuration_Debuff_Weakness,		"GameplayEffect.StatusEffect.RoundDuration.Debuff.Weakness");
	UE_DEFINE_GAMEPLAY_TAG(GameplayEffect_StatusEffect_RoundDuration_Debuff_Vulnerability,	"GameplayEffect.StatusEffect.RoundDuration.Debuff.Vulnerability");
	UE_DEFINE_GAMEPLAY_TAG(GameplayEffect_StatusEffect_RoundDuration_Debuff_Exhaustion,		"GameplayEffect.StatusEffect.RoundDuration.Debuff.Exhaustion");
	UE_DEFINE_GAMEPLAY_TAG(GameplayEffect_StatusEffect_RoundDuration_Debuff_Slow,			"GameplayEffect.StatusEffect.RoundDuration.Debuff.Slow");
	UE_DEFINE_GAMEPLAY_TAG(GameplayEffect_StatusEffect_RoundDuration_Debuff_Frail,			"GameplayEffect.StatusEffect.RoundDuration.Debuff.Frail");
	UE_DEFINE_GAMEPLAY_TAG(GameplayEffect_StatusEffect_RoundDuration_Debuff_Root,			"GameplayEffect.StatusEffect.RoundDuration.Debuff.Root");
	UE_DEFINE_GAMEPLAY_TAG(GameplayEffect_StatusEffect_RoundDuration_Debuff_Stun,			"GameplayEffect.StatusEffect.RoundDuration.Debuff.Stun");
	UE_DEFINE_GAMEPLAY_TAG(GameplayEffect_StatusEffect_RoundDuration_Debuff_Poison,			"GameplayEffect.StatusEffect.RoundDuration.Debuff.Poison");
}
