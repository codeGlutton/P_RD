/*****************************************************************//**
 * @file   TacticalPassive_AddAttack.h
...
#include "TacticalPassive_AddAttack.generated.h"

/**
 * @brief 공격력 증가 패시브
 *
 * @details
 * 대상의 공격력(DamagePoint)에 mAttackBonus만큼 더하는 무상태 패시브.
 * 패시브 내부 상태를 쓰지 않으므로 CommitPassive는 구현하지 않음(베이스 no-op).
 */
UCLASS()
class P_RD_API UTacticalPassive_AddAttack : public UTacticalPassive
{
	GENERATED_BODY()
