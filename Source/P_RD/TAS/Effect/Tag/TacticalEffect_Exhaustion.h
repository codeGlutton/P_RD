 ...
 */
UCLASS()
class P_RD_API UTacticalEffect_Exhaustion : public UTacticalEffect_DurationStatus
{
	GENERATED_BODY()
...
/**
 * @brief Exhaustion(탈진) 변화 이펙트
 */
UCLASS()
class P_RD_API UTacticalEffect_AddExhaustion : public UTacticalEffect_AddStatus
{
	GENERATED_BODY()

public:
	UTacticalEffect_AddExhaustion();
};
 ...
 */
UCLASS()
class P_RD_API UTacticalEffect_GetExhaustion : public UTacticalEffect_GetStatus
{
	GENERATED_BODY()
