 ...
 * - BeginRoom(): 방에 들어오면 현재 Run 저장과 입력 세팅을 시작한다.
...
{
	/*
	 * 실제 방 공용 팝업은 각 방 HUD에 직접 넣지 않고 WorldWidgetSubsystem에 등록해둔다.
...
/**
 * @brief 실제 방에 들어오면 현재 Run 저장과 입력 세팅을 시작한다.
 *
 * @details
...
{
	/*
	 * WorldMap과 FrontendMapWidget이 현재 런 요약을 표시할 때 쓰는 UI DTO다.
