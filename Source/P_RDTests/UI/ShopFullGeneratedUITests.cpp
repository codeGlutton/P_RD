...
namespace ShopFullGeneratedUITests
{
	...
	constexpr TCHAR RailScrimTexturePackage[] =
		TEXT("/Game/SVN/OutSideAsset/AICreation/UI/ShopFullGenerated/T_ShopFG_RailScrimGradient");
	...
	const TCHAR* ReusedChromeTexturePackages[] = {
		...
		TEXT("/Game/SVN/OutSideAsset/AICreation/UI/ShopFullGenerated/T_ShopFG_RestUnitPanel_Clean"),
		TEXT("/Game/SVN/OutSideAsset/AICreation/UI/ShopFullGenerated/T_ShopFG_SkillSlot07_Square"),
		TEXT("/Game/SVN/OutSideAsset/AICreation/UI/ShopFullGenerated/T_ShopFG_SkillSlot07_Square_Selected"),
