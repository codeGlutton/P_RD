...
#include "UI/RewardBSSlots.inl"
	...
	{
		FTextureSet T;
		T.ModalBackground = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/AtomicV11/T_R11_ModalBackground.T_R11_ModalBackground"));
		T.ParchmentSheet = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/AtomicV11/T_R11_ParchmentSheet.T_R11_ParchmentSheet"));
		T.HeaderPlate = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/AtomicV11/T_R11_HeaderPlate.T_R11_HeaderPlate"));
		T.StepPlate = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/AtomicV11/T_R11_StepPlate.T_R11_StepPlate"));
		T.CtaPlate = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/AtomicV11/T_R11_CtaPlate.T_R11_CtaPlate"));
		T.ExpRowPlate = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/AtomicV12/T_R12_ExpRowPlate.T_R12_ExpRowPlate"));
		T.ExpPortraitRing = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/AtomicV12/T_R12_ExpPortraitRing.T_R12_ExpPortraitRing"));
		T.ExpLevelWindow = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/AtomicV12/T_R12_ExpLevelWindow.T_R12_ExpLevelWindow"));
		T.ExpProgressTrack = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/AtomicV12/T_R12_ExpProgressTrack.T_R12_ExpProgressTrack"));
		T.ExpXpBadge = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/AtomicV12/T_R12_ExpXpBadge.T_R12_ExpXpBadge"));
		T.ProgressFill = Texture(TEXT("/Game/UI/ResultBoards/Art/T_VR_ProgressFill_0809.T_VR_ProgressFill_0809"));
		T.GoldCoinRing = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/AtomicV12/T_R12_GoldCoinRing.T_R12_GoldCoinRing"));
		T.GoldAmountWindow = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/AtomicV12/T_R12_GoldAmountWindow.T_R12_GoldAmountWindow"));
		T.CardFrame = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/AtomicV12/T_R12_CardFrame.T_R12_CardFrame"));
		T.CardNamePlate = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/AtomicV12/T_R12_CardNamePlate.T_R12_CardNamePlate"));
		T.CardSelectedOverlay = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/AtomicV12/T_R12_CardSelectedOverlay.T_R12_CardSelectedOverlay"));
		T.ChestClosed = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/V8PartsV2/T_RS_V8_ChestClosed.T_RS_V8_ChestClosed"));
		T.ChestAura = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/V8PartsV2/T_RS_V8_ChestAura.T_RS_V8_ChestAura"));
		T.ChestBurst = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/V8PartsV2/T_RS_V8_ChestBurst.T_RS_V8_ChestBurst"));
	...
	{
		FC03Textures T;
		T.BoardInterior = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/C03/T_C03_BoardInterior.T_C03_BoardInterior"));
		T.RailH = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/C03/T_C03_RailH.T_C03_RailH"));
		T.RailVLeft = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/C03/T_C03_RailVLeft.T_C03_RailVLeft"));
		T.RailVRight = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/C03/T_C03_RailVRight.T_C03_RailVRight"));
		T.CornerTL = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/C03/T_C03_CornerTL.T_C03_CornerTL"));
		T.CornerTR = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/C03/T_C03_CornerTR.T_C03_CornerTR"));
		T.CornerBL = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/C03/T_C03_CornerBL.T_C03_CornerBL"));
		T.CornerBR = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/C03/T_C03_CornerBR.T_C03_CornerBR"));
		T.TitlePlate = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/C03/T_C03_TitlePlate.T_C03_TitlePlate"));
		T.StageTab = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/C03/T_C03_StageTab.T_C03_StageTab"));
		T.CoinActive = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/C03/T_C03_StepCoinActive.T_C03_StepCoinActive"));
		T.CoinInactive = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/C03/T_C03_StepCoinInactive.T_C03_StepCoinInactive"));
		T.BarTrack = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/C03/T_C03_StepBarTrack.T_C03_StepBarTrack"));
		T.BarFill = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/C03/T_C03_StepBarFill.T_C03_StepBarFill"));
		T.CtaPlate = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/C03/T_C03_CtaPlate.T_C03_CtaPlate"));
		T.ParchWindow = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/C03/T_C03_ParchWindow.T_C03_ParchWindow"));
		T.XpBadge = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/C03/T_C03_XpBadge.T_C03_XpBadge"));
		T.TrackPlate = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/C03/T_C03_TrackPlate.T_C03_TrackPlate"));
		T.TrackFill = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/C03/T_C03_TrackFill.T_C03_TrackFill"));
		T.CardBlank = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/C03/T_C03_CardBlank.T_C03_CardBlank"));
		T.SelectionGlow = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/C03/T_C03_SelectionGlow.T_C03_SelectionGlow"));
		T.ChestVisual = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/C03/T_C03_ChestVisual.T_C03_ChestVisual"));
		T.GoldCoinVisual = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/C03/T_C03_GoldCoinVisual.T_C03_GoldCoinVisual"));
		T.Portraits[0] = Texture(TEXT("/Game/SVN/OutSideAsset/AICreation/UI/Marchbound/Mercenaries/T_MB_HireIcon_Knight.T_MB_HireIcon_Knight"));
		T.Portraits[1] = Texture(TEXT("/Game/SVN/OutSideAsset/AICreation/UI/Marchbound/Mercenaries/T_MB_HireIcon_Mage.T_MB_HireIcon_Mage"));
		T.Portraits[2] = Texture(TEXT("/Game/SVN/OutSideAsset/AICreation/UI/Marchbound/Mercenaries/T_MB_HireIcon_Rogue.T_MB_HireIcon_Rogue"));
		T.Artifacts[0] = Texture(TEXT("/Game/SVN/OutSideAsset/AICreation/UI/Artifacts/T_Artifact_BloodChalice.T_Artifact_BloodChalice"));
	...
	{
		FBSTextures T;
		T.BattleBackdrop = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/BS/T_BS_BattleBackdrop.T_BS_BattleBackdrop"));
		// 자유 생성된 BS 파츠는 품질 상한이 낮아 폐기하고, 목업에서 검증된
		// C03 아트 라이브러리를 공유한다. BS 고유 자산은 전투 배경과 버스트뿐.
		T.SheetBackground = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/C03/T_C03_BoardInterior.T_C03_BoardInterior"));
		T.RailH = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/C03/T_C03_RailH.T_C03_RailH"));
		T.RailVLeft = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/C03/T_C03_RailVLeft.T_C03_RailVLeft"));
		T.RailVRight = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/C03/T_C03_RailVRight.T_C03_RailVRight"));
		T.CornerTL = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/C03/T_C03_CornerTL.T_C03_CornerTL"));
		...
		T.TitlePlate = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/C03/T_C03_TitlePlate.T_C03_TitlePlate"));
		T.StageTab = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/C03/T_C03_StageTab.T_C03_StageTab"));
		T.StepTrack = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/C03/T_C03_StepBarTrack.T_C03_StepBarTrack"));
		T.StepFill = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/C03/T_C03_StepBarFill.T_C03_StepBarFill"));
		T.CoinActive = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/C03/T_C03_StepCoinActive.T_C03_StepCoinActive"));
		T.CoinInactive = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/C03/T_C03_StepCoinInactive.T_C03_StepCoinInactive"));
		T.CtaButton = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/C03/T_C03_CtaPlate.T_C03_CtaPlate"));
		T.ParchmentWindow = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/C03/T_C03_ParchWindow.T_C03_ParchWindow"));
		T.XpTrack = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/C03/T_C03_TrackPlate.T_C03_TrackPlate"));
		T.XpFill = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/C03/T_C03_TrackFill.T_C03_TrackFill"));
		T.CardBlank = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/C03/T_C03_CardBlank.T_C03_CardBlank"));
		T.SelectionGlow = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/C03/T_C03_SelectionGlow.T_C03_SelectionGlow"));
		T.ChestBurst = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/BS/T_BS_ChestBurst.T_BS_ChestBurst"));
		// BS 시트 인테리어는 C03 차콜과 톤이 달라, 불투명 크롭 배경이 사각
		// 패치로 보인다. 가장자리를 페더링한 변형을 쓴다.
		T.ChestVisual = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/C03/T_C03_ChestVisualSoft.T_C03_ChestVisualSoft"));
		T.GoldCoinVisual = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/C03/T_C03_GoldCoinVisualSoft.T_C03_GoldCoinVisualSoft"));
		T.XpBadge = Texture(TEXT("/Game/UI/ResultBoards/GeneratedArt/C03/T_C03_XpBadge.T_C03_XpBadge"));
		T.Portraits[0] = Texture(TEXT("/Game/SVN/OutSideAsset/AICreation/UI/Marchbound/Mercenaries/T_MB_HireIcon_Knight.T_MB_HireIcon_Knight"));
		T.Portraits[1] = Texture(TEXT("/Game/SVN/OutSideAsset/AICreation/UI/Marchbound/Mercenaries/T_MB_HireIcon_Mage.T_MB_HireIcon_Mage"));
		T.Portraits[2] = Texture(TEXT("/Game/SVN/OutSideAsset/AICreation/UI/Marchbound/Mercenaries/T_MB_HireIcon_Rogue.T_MB_HireIcon_Rogue"));
