...
SOURCE_DIR = ROOT / "Content" / "SVN" / "OutSideAsset" / "SFX" / "DevelopmentCandidates" / "ExternalActionCandidates"
DESTINATION_PATH = "/Game/SVN/OutSideAsset/SFX/DevelopmentCandidates/ExternalActionCandidates"
