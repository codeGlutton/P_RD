...
OUT = Path("D:/UnrealProjects/P_RD_develop_20260803/Saved/LegacyAudit/settings_tree.txt")
ASSET = "/Game/UI/WBP_SettingsPanel"
LINES = []

NAMES = ['SettingsRoot', 'SettingsPanelRoot', 'RootCanvas', 'CanvasPanel_0', 'Set_root', 'Set_scrim', 'Set_panel_frame', 'SettingsTitleText', 'BackButton', 'SaveAndExitButton', 'RunActionsPanel', 'AbandonConfirmPanel', 'MasterVolumeSlider', 'Set_grid_base', 'Set_grid_fold', 'Set_btn_close']
