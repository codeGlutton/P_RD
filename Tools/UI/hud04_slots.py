...
DETAIL = {
    "action_bottom": {
        "action_name": (769, 693, 142, 27),
        "action_icon": (795, 722, 89, 89),
        "cost_badge": (875, 741, 49, 51),
        "cooldown_overlay": (750, 673, 180, 196),
        "cooldown_text": (769, 693, 142, 157),
        "damage_text": (769, 812, 142, 19),
        "stance_text": (769, 831, 142, 19),
    },
    "action_left_lower": {
        "action_name": (525, 569, 142, 27),
        "action_icon": (551, 598, 89, 89),
        "cost_badge": (631, 617, 49, 51),
        "cooldown_overlay": (506, 549, 180, 196),
        "cooldown_text": (525, 569, 142, 157),
        "damage_text": (525, 688, 142, 19),
        "stance_text": (525, 707, 142, 19),
    },
    "action_left_upper": {
        "action_name": (525, 330, 142, 27),
        "action_icon": (551, 359, 89, 89),
        "cost_badge": (631, 378, 49, 51),
        "cooldown_overlay": (506, 310, 180, 196),
        "cooldown_text": (525, 330, 142, 157),
        "damage_text": (525, 449, 142, 19),
        "stance_text": (525, 468, 142, 19),
    },
    "action_right_lower": {
        "action_name": (999, 569, 142, 27),
        "action_icon": (1025, 598, 89, 89),
        "cost_badge": (1105, 617, 49, 51),
        "cooldown_overlay": (980, 549, 180, 196),
        "cooldown_text": (999, 569, 142, 157),
        "damage_text": (999, 688, 142, 19),
        "stance_text": (999, 707, 142, 19),
    },
    "action_right_upper": {
        "action_name": (999, 330, 142, 27),
        "action_icon": (1025, 359, 89, 89),
        "cost_badge": (1105, 378, 49, 51),
        "cooldown_overlay": (980, 310, 180, 196),
        "cooldown_text": (999, 330, 142, 157),
        "damage_text": (999, 449, 142, 19),
        "stance_text": (999, 468, 142, 19),
    },
    "action_top": {
        "action_name": (769, 205, 142, 27),
        "action_icon": (795, 234, 89, 89),
        "cost_badge": (875, 253, 49, 51),
        "cooldown_overlay": (750, 185, 180, 196),
        "cooldown_text": (769, 205, 142, 157),
        "damage_text": (769, 324, 142, 19),
        "stance_text": (769, 343, 142, 19),
    },
    "bottom_right_button": {
        "button_label": (1359, 811, 264, 74),
    },
    "bottom_status_center": {
        "party_portrait": (259, 790, 65, 80),
        "character_name": (328, 790, 61, 27),
        "hp_icon": (329, 820, 24, 24),
        "hp_value": (357, 820, 66, 25),
        "hp_bar": (329, 848, 94, 14),
        "ap_gems": (261, 875, 165, 31),
        "status_icon": (323, 843, 25, 27),
        "status_text": (350, 847, 72, 24),
        "selected_outline": (232, 761, 217, 166),
    },
    "bottom_status_left": {
        "party_portrait": (37, 790, 65, 80),
        "character_name": (106, 790, 61, 27),
        "hp_icon": (107, 820, 24, 24),
        "hp_value": (135, 820, 66, 25),
        "hp_bar": (107, 848, 94, 14),
        "ap_gems": (39, 875, 165, 31),
        "status_icon": (101, 843, 25, 27),
        "status_text": (128, 847, 72, 24),
        "selected_outline": (10, 761, 217, 166),
    },
    "bottom_status_right": {
        "party_portrait": (481, 789, 65, 80),
        "character_name": (550, 789, 61, 27),
        "hp_icon": (551, 819, 24, 24),
        "hp_value": (579, 819, 66, 25),
        "hp_bar": (551, 847, 94, 14),
        "ap_gems": (483, 874, 165, 31),
        "status_icon": (545, 842, 25, 27),
