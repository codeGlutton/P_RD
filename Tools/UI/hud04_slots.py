...
DETAIL = {
    ...
    "bottom_status_right": {
        "party_portrait": (475, 785, 65, 80),
        "character_name": (545, 789, 46, 27),
        "hp_icon": (545, 813, 24, 24),
        "hp_value": (573, 813, 64, 25),
        "hp_bar": (572, 837, 79, 14),
        "status_icon": (545, 842, 25, 27),
        "status_text": (572, 846, 72, 24),
        "ap_gems": (542, 871, 108, 31),
